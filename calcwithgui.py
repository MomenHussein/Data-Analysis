...
# Label
data = StringVar()
disp = Entry(root, font="Verdana 20", fg="black", bg="white", bd=4, justify=RIGHT, insertbackground="#abbab1", cursor="arrow")
...
btnml.pack(side=RIGHT, expand=TRUE, fill=BOTH)
# Row 4 Buttons
btnrow4 = Frame(root)
btnrow4.pack(expand=TRUE, fill=BOTH)
mod_btn = Button(btnrow4, text="%", font="Segoe 21", relief=GROOVE, bd=0, command=mod_clicked, fg="white", bg="#333333")
mod_btn.pack(side=RIGHT, expand=TRUE, fill=BOTH)
bl_btn = Button(btnrow4, text=" ) ", font="Segoe 21", relief=GROOVE, bd=0, command=br_clicked, fg="white", bg="#333333")
bl_btn.pack(side=RIGHT, expand=TRUE, fill=BOTH)
br_btn = Button(btnrow4, text=" ( ", font="Segoe 21", relief=GROOVE, bd=0, command=bl_clicked, fg="white", bg="#333333")
br_btn.pack(side=RIGHT, expand=TRUE, fill=BOTH)
dot_btn = Button(btnrow4, text=" • ", font="Segoe 21", relief=GROOVE, bd=0, command=dot_clicked, fg="white", bg="#333333")
dot_btn.pack(side=RIGHT, expand=TRUE, fill=BOTH)
btnc = Button(btnrow4, text="C", font="Segoe 23", relief=GROOVE, bd=0, command=btnc_clicked, fg="white", bg="#333333")
btnc.pack(side=RIGHT, expand=TRUE, fill=BOTH)
...
btnd.pack(side=RIGHT, expand=TRUE, fill=BOTH)
root.mainloop()
